// https://observablehq.com/@fil/plot-splom@552
...
md`_This new build of Plot exposes Plot.transform and Plot.channel, allowing the composition of elaborate transforms. In this case, the custom **normalizeMaxY** transform is applied after binning and stacking, and reduces the highest bar of each facet to the maximum height = 0.8._`
)}
...
require("@observablehq/plot@^0.4.3").then(
  (Plot) => ((Plot.channel = Plot.column), Plot)
)
)}
